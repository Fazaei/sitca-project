                    ...
                    <div className="w-full flex flex-col lg:mt-12 mt-5">
                        ...
                        <div className="mt-2 relative z-10">
                            <div style={{background: "#6C63FF80"}} className="w-full rounded-full lg:h-2.5 h-1.5">
                                <div id="progress" className=" relative bg-gradient-to-r from-blue-700 from-10% to-purple-700 to-50% lg:h-2.5 h-1.5 rounded-full box-border" style={{width: skill.value+"%",boxShadow: "100px"}}></div>
                            </div>
                        </div>
